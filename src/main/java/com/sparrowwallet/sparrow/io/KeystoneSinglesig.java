...
public class KeystoneSinglesig implements KeystoreFileImport, WalletImport {
    ...
    public String getKeystoreImportDescription(int account) {
        return "Import file or QR created by using the My Keystone > ... > Export Wallet feature on your Keystone. Make sure to set the Watch-only Wallet to Sparrow-GRS in the Settings first.";
    }
